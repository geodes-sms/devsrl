...
class TrafficLight(AtomicDEVS):
    ...
    def updateTa(self, color, timeAdvance):
        print("Warning: time advance updated")
        self.ta[color] = timeAdvance
        
    def updateAllTa(self, timeAdvance):
        self.ta['red'] = timeAdvance[0]
        self.ta['green'] = timeAdvance[1]
        self.ta['yellow'] = timeAdvance[2]
    ...
    def timeAdvance(self):
        ...
        if state == "red":
            ...
            return self.ta['green']
        elif state == "yellow":
            return self.ta['yellow']
        elif state == "manual":
            return self.ta['manual']
        else:
            raise DEVSException(\
